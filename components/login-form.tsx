  ...
  return (
    <div className="w-full">
      ...
      <div className="text-left mb-8">
        <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl shadow-xl mb-6">
          <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 24 24">
            <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5" />
          </svg>
        </div>
        <h1 className="text-3xl font-bold text-slate-900 mb-2">Welcome back</h1>
        <p className="text-slate-600">Sign in to your Maritime Talent Quest account</p>
      </div>
      ...
      <div className="mt-8 text-left">
        <p className="text-sm text-slate-600">
          ...
          <a href="/registration" className="font-medium text-slate-900 hover:text-slate-700 transition-colors">
            Sign up
          </a>
        </p>
      </div>
